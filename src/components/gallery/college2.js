...
function College() {
  const variables = [
    ...
    },
    {
      ...
      keep1: 'H.S. graduate or less',
      keep2: 'College graduate+',
    },
    {
      color: 'yellow',
      demo: 'Churchattend',
      display_name: 'Church Attendance',
      keep1: 'Rarely',
      keep2: 'Weekly+',
    },
    {
...

    {
      color: 'red',
      demo: 'F_METRO',
      display_name: 'Metro vs. Urban',
      keep1: 'Non-metropolitan',
      keep2: 'Metropolitan',
    },
    {
      color: 'blue',
  ...
  return (
    <div>
      <Demographics
        ...
        demos={demos}
        variables={variables}
        axislabel={'% Should be Major Factor'}
        isBinary={true}
        shortname={
          'Do you think each of the following should be a major factor, minor factor, or not a factor incollege admissions?'
        }
      />
    </div>
  );
